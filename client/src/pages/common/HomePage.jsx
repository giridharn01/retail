    ...
    try {
      ...
      setFeaturedProducts([
        {
          ...
          description: 'Automated irrigation system with weather-based scheduling',
          price: 24999.99,
        ...
        },
        {
          ...
          description: 'Complete solar power solution for home and farm',
          price: 74999.99,
        ...
        {
          _id: 3,
          name: 'Smart Farming Sensors',
          description: 'Soil moisture and temperature monitoring system',
          price: 16699.99,
          image: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80'
        }
      ]);
      ...
      setServices([
        ...
        },
        {
          ...
          description: 'Quality hardware tools and equipment for all your needs',
          icon: '🔧'
        },
        {
          _id: 3,
          name: 'Agri-Tech Support',
          description: 'Modern farming solutions and technical support',
          icon: '🌱'
        },
        {
          _id: 4,
          name: 'Solar Installation',
          description: 'Expert solar panel installation and maintenance',
          icon: '☀️'
        }
      ]);
    } finally {
